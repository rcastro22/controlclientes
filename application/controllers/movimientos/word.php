...
class word extends MY_Controller
{
		...
		try {
			...
			foreach ($datosInmuebles as $inmueble) {
				...
				if($tipoIn == 1) {
					...
					$inmueblesTxt = $inmueblesTxt."(".$inmueble->idinmueble." ".str_replace("FABRA", "",strtoupper($inmueble->modelo)).") del ".strtolower($this->toTextOrdinals(abs($inmueble->sotano)))." ".$strNivel." (".abs($inmueble->sotano).")";
				}
				else {
					$inmueblesTxt = $inmueblesTxt."(".$inmueble->idinmueble.") del ".strtolower($this->toTextOrdinals(abs($inmueble->sotano)))." ".$strNivel." (".abs($inmueble->sotano)."), ";
				}
			}
    ...
    public function toTextOrdinals($value) {
        ...
        if ($value == 0) $Num2Text = "CERO";
        else if ($value == 1) $Num2Text = "PRIMER";
        ...
        else if ($value == 20) $Num2Text = "VIGESIMO";
        //else if ($value < 30) $Num2Text = "VEINTI" . $this->toText($value - 20);
        else if ($value == 30) $Num2Text = "TRIGESIMO";
        else if ($value == 40) $Num2Text = "CUADRAGESIMO";
        else if ($value == 50) $Num2Text = "QUINCUAGESIMO";
        else if ($value == 60) $Num2Text = "SEXAGESIMO";
        else if ($value == 70) $Num2Text = "SEPTUAGESIMO";
        else if ($value == 80) $Num2Text = "OCTAGESIMO";
        else if ($value == 90) $Num2Text = "NONAGESIMO";
        else if ($value < 100) $Num2Text = $this->toTextOrdinals(floor($value / 10) * 10) . " " . $this->toTextOrdinals($value % 10);
        else if ($value == 100) $Num2Text = "CENTESIMO";
        else if ($value < 200) $Num2Text = "CIENTO " . $this->toTextOrdinals($value - 100);
        else if (($value == 200) || ($value == 300) || ($value == 400) || ($value == 600) || ($value == 800)) $Num2Text = $this->toTextOrdinals(floor($value / 100) ) . "CIENTOS";
        else if ($value == 500) $Num2Text = "QUINIENTOS";
        else if ($value == 700) $Num2Text = "SETECIENTOS";
        else if ($value == 900) $Num2Text = "NOVECIENTOS";
        else if ($value < 1000) $Num2Text = $this->toTextOrdinals(floor($value / 100) * 100) . " " . $this->toTextOrdinals($value % 100);
        else if ($value == 1000) $Num2Text = "MIL";
        else if ($value < 2000) $Num2Text = "MIL " . $this->toTextOrdinals($value % 1000);
        else if ($value < 1000000)
        {
            $Num2Text = $this->toTextOrdinals(floor($value / 1000)) . " MIL";
            if (($value % 1000) > 0) $Num2Text = $Num2Text . " " . $this->toTextOrdinals($value % 1000);
        }
        else if ($value == 1000000) $Num2Text = "UN MILLON";
        else if ($value < 2000000) $Num2Text = "UN MILLON " . $this->toTextOrdinals($value % 1000000);
        else if ($value < 1000000000000)
        {
            $Num2Text = $this->toTextOrdinals(floor($value / 1000000)) . " MILLONES ";
            if (($value - floor($value / 1000000) * 1000000) > 0) $Num2Text = $Num2Text . " " . $this->toTextOrdinals($value - floor($value / 1000000) * 1000000);
        }
        else if ($value == 1000000000000) $Num2Text = "UN BILLON";
        else if ($value < 2000000000000) $Num2Text = "UN BILLON " . $this->toTextOrdinals($value - floor($value / 1000000000000) * 1000000000000);
        else
        {
            $Num2Text = $this->toTextOrdinals(floor($value / 1000000000000)) . " BILLONES";
            if (($value - floor($value / 1000000000000) * 1000000000000) > 0) $Num2Text = $Num2Text . " " . $this->toTextOrdinals($value - floor($value / 1000000000000) * 1000000000000);
        }
        return $Num2Text;
